...
const ViewInvoices = () => {
  ...
  // Confirmation function to prevent accidental deletion
  const confirmDeleteInvoice = (customerName, createdAt) => {
    Alert.alert(
      'Delete Invoice',
      'Are you sure you want to delete this invoice?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'OK', onPress: () => deleteInvoice(customerName, createdAt) }
      ],
      { cancelable: true }
    );
  };
  ...
  const renderInvoice = ({ item }) => (
    <View style={styles.invoiceItem}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => confirmDeleteInvoice(item.customer_name, item.created_at)}
      >
