...
//     // useEffect(() => {
//     //     // Update the state whenever the global state changes
//     //     setTotalCount(globalState.totalCount)
//     //     setTotalPendingAmount(globalState.totalPendingAmount);
//     // }, [globalState.totalPendingAmount, globalState.totalCount]);
...
//                 <TouchableOpacity onPress={() => navigation.navigate('HomeforNewVehicle')}>
//                     <Text
//                     style={styles.actions}
//                     >
//                         Add New Vehicle {'\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t'} <Image source={require("../assets/images/right-arrow.png")}
//                         style={{height: 10}}/>{'\n'}
//                     </Text>
//                 </TouchableOpacity>

//                 <TouchableOpacity onPress={() => navigation.navigate('exportData')}>
//                     <Text
//                     style={styles.actions}
//                     >
//                         Export Data {'\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t'} <Image source={require("../assets/images/right-arrow.png")}
//                         style={{height: 10}}/>{'\n'}
//                     </Text>
//                 </TouchableOpacity>

//                 <TouchableOpacity onPress={() => navigation.navigate('DeleteVehicle')}>
//                     <Text
//                     style={styles.actions}
//                     >
//                         Delete Vehicle {'\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t'} <Image source={require("../assets/images/right-arrow.png")}
//                         style={{height: 10}}/>
//                     </Text>
//                 </TouchableOpacity>
